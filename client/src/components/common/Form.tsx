import {
  ...
  FormHelperText, TextField, TextareaAutosize, Stack,
    ...
    <Box>
      ...
      <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#fcfcfc">
        ...
        >
          ...
          <FormControl>
            <FormHelperText sx={{
              fontWeight: 500, margin: '10px 0', fontSize: 16,
              color: '#11142d'
            }}>
              Enter Property Name
            </FormHelperText>
          ...
          <FormControl>
            ...
            <TextareaAutosize
              ...
              style={{
                ...
                fontSize: '16px', borderColor: 'rgba(0, 0, 0, 0.23)', borderRadius: 6, padding: 10, color: '#919191'
              }}
